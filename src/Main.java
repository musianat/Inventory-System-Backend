...
public class Main {
    ...
    public static void main(String args[])throws IOException{
        ...
        File inv= new File("inventory5.dat"); //opens existing file
        File trans = new File("transaction5.log"); //opens existing file
        File kiosk = new File("redbox_kiosk5.txt");//creates new file
        ...
        while(in.hasNextLine()){
            ...
            if(isValidTitle(title)){
                ...
                if(title.contains(",")) {
                    ...
                    if (arr.length>1&&isInteger(arr[1])) { //added here
                        ...
                        if(isValidTitle(title)) {
                           ...
                           // System.out.println(op+" "+title);
                            ...
                            if(op.equals("return") || op.equals("rent")){ //added here
            ...
            if(valid) {
                ...
                if (op.equals("rent")) {
                    ...
                    if(holder!=null){
                        ...
                        //System.out.println("renting"+title+holder.getAvailable()+" "+holder.getRented());
                    ...
                    if(holder!=null){
                        ...
                        {
                          //  System.out.println(title+holder.getAvailable()+" "+holder.getRented());
